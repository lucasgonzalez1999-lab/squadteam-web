...
const MUSCLE_TO_PATHS = {
  ...
  triceps:['triceps'], abs:['abs'], traps:['traps'],
  upperBack:['upperBack'], lowerBack:['lowerBack'],
...
// ── SVG builders ────────────────────────────
// Paths anatómicos de react-native-body-highlighter (MIT).
// Front: contenido en x≈54..648, y≈168..1340.
// Back:  contenido en x≈789..1384, y≈166..1341.
// Cada grupo muscular relevante se envuelve en un <g id="…"> para que applyTiers
// cambie su fill (heredado por sus paths hijos).

const FRONT_PATHS = `
  <g id="silhouette" fill="#16181c">
  ...
  <g id="shoulders" fill="#2e2e2e" stroke="#0a0b0d" stroke-width="0.8" stroke-linejoin="round">
  ...
  <g id="biceps" fill="#2e2e2e" stroke="#0a0b0d" stroke-width="0.8" stroke-linejoin="round">
  ...
  <g id="abs" fill="#2e2e2e" stroke="#0a0b0d" stroke-width="0.8" stroke-linejoin="round">
  ...
  <g id="quads" fill="#2e2e2e" stroke="#0a0b0d" stroke-width="0.8" stroke-linejoin="round">
  ...
  <g id="calves" fill="#2e2e2e" stroke="#0a0b0d" stroke-width="0.8" stroke-linejoin="round">
...
const BACK_PATHS = `
  ...
  <g id="triceps" fill="#2e2e2e" stroke="#0a0b0d" stroke-width="0.8" stroke-linejoin="round">
  ...
  <g id="traps" fill="#2e2e2e" stroke="#0a0b0d" stroke-width="0.8" stroke-linejoin="round">
  ...
  <g id="upperBack" fill="#2e2e2e" stroke="#0a0b0d" stroke-width="0.8" stroke-linejoin="round">
  ...
  <g id="lowerBack" fill="#2e2e2e" stroke="#0a0b0d" stroke-width="0.8" stroke-linejoin="round">
  ...
  <g id="glutes" fill="#2e2e2e" stroke="#0a0b0d" stroke-width="0.8" stroke-linejoin="round">
  ...
  <g id="hamstrings" fill="#2e2e2e" stroke="#0a0b0d" stroke-width="0.8" stroke-linejoin="round">
...
function svgFront(){
  return `<svg id="body-front" class="mm-svg" viewBox="40 150 620 1210" xmlns="http://www.w3.org/2000/svg">
    ${FRONT_PATHS}
  </svg>`;
}

function svgBack(){
  return `<svg id="body-back" class="mm-svg" viewBox="780 150 620 1210" xmlns="http://www.w3.org/2000/svg">
    ${BACK_PATHS}
  </svg>`;
}
